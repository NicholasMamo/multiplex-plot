...
You can also check out the `time series tutorial Jupyter Notebook <https://github.com/NicholasMamo/multiplex-plot/blob/master/examples/3.%20Time%20Series.ipynb>`_.
