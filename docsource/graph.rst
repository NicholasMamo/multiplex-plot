...
.. meta::
   :description: Python graph or network visualizations to plot nodes and edges
...
.. note::
	...
	Check out the `network graph tutorial Jupyter Notebook <https://github.com/NicholasMamo/multiplex-plot/blob/master/examples/4.%20Network%20graphs.ipynb>`_.
